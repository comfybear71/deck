...
- **Next**: **Sunnybank** — an Australian outback adult-cartoon sitcom,
  ...
  snapshots those buffers for this open sheet only (not
  `localStorage`, not a new Neon table), always minting a new card,
  each with a red ✕.
